...
async function ajoutMateriel() {
  ...
  if(document.getElementById('choixOption').value === 'camera'){
    source=document.getElementById('photo').src
    image=source
  }
  ...
  formData.append("action", "addmateriel");
  ...
  if(document.getElementById('choixOption').value === 'camera'){
    formData.append("typeimage","camera");
  }
  else{
    formData.append("typeimage","fichier");
  }
...
$(document).ready(function () {
  $("#addMaterielForm").submit(function (e) {
    e.preventDefault();
    ajoutMateriel();
